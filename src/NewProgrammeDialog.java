...
public class NewProgrammeDialog extends JDialog {
    ...
    public NewProgrammeDialog(JFrame frame) {
        ...
        error9 = new JLabel("The Programme Code you entered is used. Please try another one.");
        ...
        button1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                boolean flag = false, flag1 = false, flag2 = false, flag3 = false, flag4 = false, flag5 = false, flag6 = false, flag7 = false, flag8 = false;
                ...
                if ((textfield1.getText().trim() == null) || (textfield1.getText().trim().equalsIgnoreCase(""))) {
                    ...
                    error9.setVisible(false);
                    flag = false;
                } else if (!((textfield1.getText().trim()).matches("^[F][0-9]{3}$"))) {
                    error2.setVisible(false);
                    error9.setVisible(false);
                ...
                for (int count3 = 0; count3 < RYCOXv2.prgList.size(); count3++) {
                    if ((RYCOXv2.prgList.get(count3).getProgCode()).equals(textfield1.getText().trim())) {
                ...
                if ((flag == true) && (flag7 == true)) {
                    flag8 = true;
                    error2.setVisible(false);
                    error1.setVisible(false);
                    error9.setVisible(false);
                    a = textfield1.getText().trim();
                } else
                    flag8 = false;
                ...
                if ((flag8 == true) && (flag1 == true) && (flag2 == true) && (flag3 == true) && (flag4 == true) && (flag5 == true) && (flag6 == true)) {
                    RYCOXv2.prgList.addLast(new TVProgramme(a, b, y, d, "Active", z, f, g));
                    JOptionPane.showMessageDialog(null, "You have successfully created a new TV Programme " + a + " !", a + " added", JOptionPane.PLAIN_MESSAGE);
        ...
        spring.putConstraint(SpringLayout.WEST, error2, 80, SpringLayout.EAST, label1);
        spring.putConstraint(SpringLayout.NORTH, error1, 5, SpringLayout.SOUTH, textfield1);
        spring.putConstraint(SpringLayout.WEST, error1, 80, SpringLayout.EAST, label1);
        spring.putConstraint(SpringLayout.NORTH, error9, 5, SpringLayout.SOUTH, textfield1);
        spring.putConstraint(SpringLayout.WEST, error9, 80, SpringLayout.EAST, label1);
        ...
        spring.putConstraint(SpringLayout.WEST, error3, 123, SpringLayout.EAST, label2);
        ...
        spring.putConstraint(SpringLayout.WEST, error4, 152, SpringLayout.EAST, label3);
        ...
        spring.putConstraint(SpringLayout.WEST, error5, 136, SpringLayout.EAST, label4);
        ...
        spring.putConstraint(SpringLayout.WEST, error6, 140, SpringLayout.EAST, label5);
        ...
        spring.putConstraint(SpringLayout.WEST, error7, 190, SpringLayout.EAST, label6);
        ...
        spring.putConstraint(SpringLayout.WEST, error8, 184, SpringLayout.EAST, label7);
